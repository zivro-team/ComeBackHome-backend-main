...
public interface RefreshTokenService {
    ...
    String findRefreshToken(HttpServletRequest request);

    // refresh 에 있는 정보로 access 토큰 발급
    void newCreateAccessToken(HttpServletRequest request, HttpServletResponse response);

    // 로그아웃 시 refresh 토큰 삭제
    void deleteRefreshToken(HttpServletRequest request);
}
